	...
	<div class="container">
		...
		<div class="tiles__container">
			<div class="tile-item tile-item--sm">
				<a href="javascript:;">
					<div class="tile-item__wrap--sm">
						<h4 class="tile-item__title tile-item__title--xl">0 - 2 </h4>
						<span>godine</span>
					</div>
				</a>
			</div>
			<div class="tile-item tile-item--sm">
				<a href="javascript:;">
					<div class="tile-item__wrap--sm">
						<h4 class="tile-item__title tile-item__title--xl">2 - 4 </h4>
						<span>godina</span>
					</div>
				</a>
			</div>
			<div class="tile-item tile-item--sm">
				<a href="javascript:;">
					<div class="tile-item__wrap--sm">
						<h4 class="tile-item__title tile-item__title--xl">4 - 6 </h4>
						<span>godina</span>
					</div>
				</a>
			</div>
			<div class="tile-item tile-item--sm">
				<a href="javascript:;">
					<div class="tile-item__wrap--sm">
						<h4 class="tile-item__title tile-item__title--xl">6 - 8 </h4>
						<span>godina</span>
					</div>
				</a>
			</div>
		...
		<div class="tiles__btn">
			<a class="btn" href="javascript:;">Sve igračke</a>
		</div>
	</div>
</div>